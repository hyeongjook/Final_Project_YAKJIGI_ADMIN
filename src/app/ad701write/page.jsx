...
import styles from "../styles/ad701write.module.css";
    ...
    <>
      <div className={adcommons.adcommons__main_background_color}>
        <div className={adcommons.adcommons__main_container}>
          <p className={adcommons.adcommons__main_name}>공지사항 - 글쓰기</p>
          <div className={adcommons.adcommons__main_container_box}>
            ...
            <div className={adcommons.adcommons__box}>
              <TextField fullWidth label="제목" id="fullWidth" />
            </div>
          </div>
          ...
          <div className={adcommons.adcommons__main_container_box}>
            ...
            <div className={adcommons.adcommons__box}>
            <TextareaAutosize className={styles.ad701write__textarea}
                                minRows={3}
                                maxRows={6}
                                placeholder="내용"
